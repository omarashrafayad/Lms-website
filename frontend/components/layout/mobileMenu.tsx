            ...
            <div className="flex-1 overflow-y-auto px-4 py-6 space-y-8">
                  ...
                  return (
                    ...
                    >
                      <Link
                        href={link.href}
                        onClick={onClose}
                        className={`flex items-center gap-4 px-4 py-4 rounded-xl text-base font-semibold transition-all duration-300 rtl:flex-row-reverse rtl:text-right ${isActive
              ...
              <div className="space-y-1 pb-4">
                ...
                <Link
                  ...
                  onClick={onClose}
                  className="flex items-center gap-4 px-4 py-4 rounded-xl text-base font-semibold text-muted-foreground hover:bg-muted hover:translate-x-1 rtl:hover:-translate-x-1 transition-all rtl:flex-row-reverse rtl:text-right"
                >
                  {token && user ? (
                    <>
