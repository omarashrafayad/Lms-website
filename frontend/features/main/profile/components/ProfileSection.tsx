                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col flex-1 overflow-hidden">
                  ...
                  <div className="p-6 space-y-6 overflow-y-auto custom-scrollbar">
                    ...
                    <div className="space-y-4">
                      <UniInput control={control} name="name" label="Name" placeholder="Enter your name" type="text" required className="space-y-2" />
                      <UniInput control={control} name="email" label="Email Address" placeholder="Enter your email" type="email" required className="space-y-2" />
                      <UniInput control={control} name="phone" label="Phone Number" placeholder="Enter your phone" type="text" required className="space-y-2" />
                    </div>
                  </div>

                  <DialogFooter className="p-6 border-t border-zinc-100 dark:border-zinc-800 bg-zinc-50/30 dark:bg-zinc-900/30">
                    <DialogClose render={<Button type="button" variant="ghost" className="rounded-xl h-12 w-full sm:w-auto font-bold">Cancel</Button>} />
